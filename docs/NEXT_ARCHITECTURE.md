...
| `Prototype` | Опорный реальный пример, согласованные устойчивые части, варианты, исключения и версии | Усреднять можно только сопоставленные части; редкий вариант не стирается автоматически |
...
У понятия есть устойчивая часть и семейство допустимых изменений. Опорой
сначала служит реальный пример. Новые примеры сначала согласуются по
участникам и системе отсчёта; лишь затем обновляется общее представление.
При неоднозначном согласовании поддерживаются несколько вариантов.
